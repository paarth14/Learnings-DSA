...
// Problem Statement - You are working on a ticketing system. A ticket costs $10.
...
/*Sample Input: 55
 ...
 //Explanation: The youngest age is 15, so the group gets a 15% discount from the total price, 
 //which is $50 - 15% = $42.5
...
int main() {
    ...
    double price = 50.0 - (50.0 * youngest / 100.0);
    cout<<price;
